...
function ProjectComponent({ image, location, title }) {
    return (
        <div className="overflow-hidden lg:h-96 md:h-80 h-48 rounded-xl col-span-1 flex flex-col shadow cursor-pointer">
            ...
            <div className="bg-white rounded-b-xl md:px-6 px-4 py-4 flex flex-row justify-between">
                ...
                <a  href={location} 
                    ...
                    className='text-indigo-500 border-b-2 font-bold md:text-sm text-xs border-yellow-300'>Visit Platform</a>
            </div>
        </div>
    )
}
